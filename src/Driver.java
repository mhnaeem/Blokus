...
public class Driver {
    public static void main(String[] args) {
        new Player("Player 1",Color.RED,Piece.getPieces().get(0));
        new Player("Player 2",Color.BLUE,Piece.getPieces().get(1));
        new Player("Player 3",Color.YELLOW,Piece.getPieces().get(2));
