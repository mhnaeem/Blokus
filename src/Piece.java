        ...
        for(int j = 1; j <= 4; j++){
            ...
            for (int i = 0; i < 21; i++) {
                ...
                if(i == 0){
                    ...
                    pointsOnMainScreen[3] = "6,0";
                    pointsOnMainScreen[4] = "6,1";
                }
                if(i==4){
                    actionsList.add(new int[]{0,1});
                    actionsList.add(new int[]{1,0});
